...
*/
bool h3dInit( /*H3DRenderDevice::List*/ int deviceType );
...
/* Function: h3dCompute
	...
	Returns:
		nothing
*/
void h3dCompute( H3DRes materialRes, const char *context, int groupX, int groupY, int groupZ );
...
/*	Function: h3dSetMessageCallback
	...
	Returns:
		nothing
*/
void h3dSetMessageCallback(void (*callback)(int, const char*));
...
*/
float h3dGetOption( /*H3DOptions::List*/ int param );
...
*/
bool h3dSetOption( /*H3DOptions::List*/ int param, float value );
...
*/
float h3dGetStat( /*H3DStats::List*/ int param, bool reset );
...
*/
float h3dGetDeviceCapabilities( /*H3DDeviceCapabilities::List*/ int param );
...
/* Function: h3dSetShaderPreambles
	...
	Returns:
		nothing
*/
void h3dSetShaderPreambles( const char *vertPreamble, const char *fragPreamble, const char *geomPreamble,
...
*/
bool h3dGetRenderTargetData( H3DRes pipelineRes, const char *targetName, int bufIndex,
...
/* Function: h3dSetNodeUniforms
	...
	Returns:
		nothing
*/
void h3dSetNodeUniforms( H3DNode node, const float *uniformData, int count );
...
/* Function: h3dGetModelAnimParams
	...
	Returns:
		nothing
*/
void h3dGetModelAnimParams( H3DNode modelNode, int stage, float *time, float *weight );
...
/* Function: h3dAddMeshNode
	...
	Returns:
		handle to the created node or 0 in case of failure
*/
H3DNode h3dAddMeshNode( H3DNode parent, const char *name, H3DRes materialRes, int primType,
...
/* Function: h3dSetCameraProjMat
	...
	Returns :
		nothing
*/
void h3dSetCameraProjMat( H3DNode cameraNode, float *projMat );
...
/* Function: h3dAddComputeNode
	...
	Returns:
		handle to the created node or 0 in case of failure
*/
H3DNode h3dAddComputeNode( H3DNode parent, const char *name, H3DRes materialRes, H3DRes compBufferRes, int primType, int elementsCount );
...
/* Function: h3dShowText
	...
	Returns:
		nothing
*/
void h3dShowText( const char *text, float x, float y, float size,
...
/* Function: h3dShowInfoBox
	...
	Returns:
		nothing
*/
void h3dShowInfoBox( float x, float y, float width, const char *title,
...
/* Function: h3dutShowFrameStats
	...
	Returns:
		nothing
*/
void h3dShowFrameStats( H3DRes fontMaterialRes, H3DRes panelMaterialRes, int mode );
